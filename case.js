...
╰──────❍`;
    ...
    switch (command) {
            ...
            try {
                const quoted =
                    msg.message?.extendedTextMessage?.contextInfo
                        ?.quotedMessage;
                if (!quoted)
                    return reply("❌ Balas gambar/video/stiker dengan .s");
        ...
        case "tourl": {
            try {
                ...
                if (isDocument) {
                    ...
                    ext =
                        path.extname(docName) || getExtFromMime(mime) || ".bin";
                    base =
                        path.basename(docName, path.extname(docName)) || base;
                    base = sanitize(base);
                } else {
        ...
        case "public": {
            ...
            reply("✅ Bot sekarang dalam *PUBLIC MODE*");
            break;
        }
